...
## 📐 Complete List of Equations Used

Below are all of the equations used in the dataset generator, grouped by category.  You can paste this directly into your README or documentation.
...
Paste these blocks into your Markdown documentation to give a full, step-by-step account of every equation used in data generation.
### 1. Normalized Frequency \(V\)
\[
V = \frac{2\pi\,a}{\lambda}\,\sqrt{n_{\rm core,real}^2 - n_{\rm clad,real}^2}
\]
